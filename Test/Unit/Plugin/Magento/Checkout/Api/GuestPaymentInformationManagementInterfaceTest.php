...
class GuestPaymentInformationManagementInterfaceTest extends \PHPUnit\Framework\TestCase
{
    ...
    const CART_ID = '55cce0e1a4b37b1a8808d3a0e751b229';

    /**
     * @var \MageSuite\CheckoutNewsletterSubscription\Plugin\Magento\Checkout\Api\GuestPaymentInformationManagementInterface
     */
    private $instance;
    ...
    /**
     * @var \Magento\Checkout\Api\GuestPaymentInformationManagementInterface|\PHPUnit_Framework_MockObject_MockObject
     */
    ...
    protected function setUp(): void
    {
        ...
        $this->instance = new \MageSuite\CheckoutNewsletterSubscription\Plugin\Magento\Checkout\Api\GuestPaymentInformationManagementInterface(
            $this->subscriberMock,
            $loggerMock
        );

        $this->pluginSubjectMock = $this->getMockBuilder(\Magento\Checkout\Api\GuestPaymentInformationManagementInterface::class)
            ->getMock();
    ...
    {
        return function ($cartId, $email, $paymentMethod, $billingAddress = null) use ($expectedOrderId) {
    ...
    {
        $this->assertInstanceOf(\MageSuite\CheckoutNewsletterSubscription\Plugin\Magento\Checkout\Api\GuestPaymentInformationManagementInterface::class, $this->instance);
    }
