...
class NewsletterSubscribeTest extends \PHPUnit\Framework\TestCase
{
    ...
    /**
     * @var \MageSuite\CheckoutNewsletterSubscription\Plugin\Magento\Checkout\Api\GuestPaymentInformationManagementInterface\NewsletterSubscribe
     */
    protected $instance;
    ...
    /**
     * @var \Magento\Checkout\Api\GuestPaymentInformationManagementInterface|\PHPUnit\Framework\MockObject\MockObject
     */
    ...
    protected function setUp(): void
    {
        ...
        $this->instance = new \MageSuite\CheckoutNewsletterSubscription\Plugin\Magento\Checkout\Api\GuestPaymentInformationManagementInterface\NewsletterSubscribe(
            $this->subscriberMock,
            $loggerMock
        );

        $this->pluginSubjectMock = $this->getMockBuilder(\Magento\Checkout\Api\GuestPaymentInformationManagementInterface::class)->getMock();
    ...
    {
        $this->assertInstanceOf(\MageSuite\CheckoutNewsletterSubscription\Plugin\Magento\Checkout\Api\GuestPaymentInformationManagementInterface\NewsletterSubscribe::class, $this->instance);
    }
